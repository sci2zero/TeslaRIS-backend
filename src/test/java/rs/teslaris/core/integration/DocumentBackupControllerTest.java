    ...
    public void testGenerateBackup() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post(
                        "http://localhost:8081/api/document/backup/schedule-generation?from=2022&to=2023&institutionId=1&types=INTANGIBLE_PRODUCT&sections=FILE_ITEMS&lang=sr&metadataFormat=CSV")
