...
public class PersonIndexServiceTest {
    ...
    @InjectMocks
    private PersonIndexServiceImpl personIndexService;
    ...
    public void shouldFindAll() {
        ...
        // When
        var actual = personIndexService.findAll(pageable);
    ...
    void shouldFindPeopleByNameAndEmploymentWhenProperQueryIsGiven() throws Exception {
        ...
        // when
        var result = personIndexService.findPeopleByNameAndEmployment(tokens, pageable);
