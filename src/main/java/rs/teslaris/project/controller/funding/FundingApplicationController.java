...
public class FundingApplicationController {
    ...
    public FundingApplicationDTO readFundingApplication(
    ...
    public FundingApplicationDTO createFundingApplication(
        ...
        var savedFundingApplication =
            fundingApplicationService.createFundingApplication(fundingApplicationDTO);
    ...
    public void updateFundingApplication(@PathVariable Integer fundingApplicationId,
        ...
        fundingApplicationService.updateFundingApplication(fundingApplicationId,
