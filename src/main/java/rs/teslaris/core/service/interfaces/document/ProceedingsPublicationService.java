...
public interface ProceedingsPublicationService {
    ...
    Page<DocumentPublicationIndex> findProceedingsPublicationsForEvent(Integer eventId,
                                                                       Pageable pageable);
    ...
    Integer transferJournalPublicationToProceedings(Integer journalPublicationId,
