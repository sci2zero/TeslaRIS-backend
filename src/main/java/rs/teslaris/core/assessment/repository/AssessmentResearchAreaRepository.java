...
public interface AssessmentResearchAreaRepository
    ...
    Optional<AssessmentResearchArea> findForPersonIdAndCommissionId(Integer personId, Integer commissionId);
    ...
    Set<Person> findAllForPersonIdAndCommissionIdAndCode(Integer personId, Integer commissionId, String code);
