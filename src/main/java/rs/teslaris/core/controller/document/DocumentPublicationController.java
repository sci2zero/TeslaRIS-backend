...
public class DocumentPublicationController {
    ...
    public void initBinder(WebDataBinder binder) {
        StringUtil.registerProperStringListFieldBinderEditor(binder, "titles");
    }
    ...
    public Page<DocumentPublicationIndex> deduplicationSearch(
        ...
        @RequestParam("doi") String doi, @RequestParam("scopusId") String scopusId,
        @RequestParam("openAlexId") String openAlexId,
