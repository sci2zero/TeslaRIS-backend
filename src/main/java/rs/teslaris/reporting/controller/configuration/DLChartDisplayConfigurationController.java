...
public class DLChartDisplayConfigurationController {
    ...
    public void saveDigitalLibraryChartDisplaySettings(@PathVariable Integer organisationUnitId,
                                                       @RequestBody
                                                       DigitalLibraryChartDisplaySettingsDTO settings) {
        digitalLibraryChartsDisplayConfigurationService.saveDigitalLibraryDisplaySettings(
            organisationUnitId, settings);
    }
}
