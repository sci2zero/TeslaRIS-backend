...
@Slf4j
public class OAIPMHMigratorImpl implements OAIPMHMigrator {
    ...
    @Override
    public void harvest(DataSet requestDataSet, OAIPMHMigrationSource source, Integer userId) {
        String endpoint =
    ...
    private void updateProgressReport(DataSet requestDataSet, String resumptionToken,
        ...
        mongoTemplate.save(
            new HarvestProgressReport(resumptionToken, userId, requestDataSet.name()));
    }
